...
namespace ComiqueriaApp
{
    public partial class PrincipalForm : Form
    {
        ...
        {
            AgregarProductoForm form = new AgregarProductoForm(this.productoSeleccionado);
            form.ShowDialog();
        }
        ...
        private void btnEliminar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (result == DialogResult.Yes)
                {
                    ...
                    if (db.Eliminar(this.productoSeleccionado))
                        MessageBox.Show("Se elimino...", "Atencion", MessageBoxButtons.OK, MessageBoxIcon.Stop);
                }
            }
            catch (Exception ex)
            {
        ...
        {
            // Punto 9. Instanciar y correr un nuevo hilo que ejecute un método que actualice el “lblFechaHora” 
            //cada 1 segundo con la fecha y la hora actual. 
            this.hilo = new Thread(ActualizarFechaHora);
            hilo.Start();
        }
