    ...
    public partial class AgregarProductoForm : Form
    {
        ...
        private void BtnAgregar_Click(object sender, EventArgs e)
        {
            if (Validar())
            {
                ...
                this.producto.Descripcion = nuevaDescripcion;
                this.producto.Precio = nuevoPrecio;
                ...
                if (db.Guardar(this.producto))
                    MessageBox.Show("Guardado en la Base de Datos", "Exito", MessageBoxButtons.OK, MessageBoxIcon.Hand);
                this.Close();
            }
        }
