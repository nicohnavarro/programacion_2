...
namespace ComiqueriaLogic
{
    public class Comiqueria
    {
        ...
        public Comiqueria()
        {
            ...
            this.productos = db.Leer();
            this.ventas = new List<Venta>();
            ProductoDAO.MiEvento += ManejadorEvento;
        ...
        public void Vender(Producto producto, int cantidad)
        {
            ...
            Serializador<Venta>.GuardarBinario(ruta, nuevaVenta);
        ...
        public void ManejadorEvento(AccionesDB accion)
        {
            this.Productos = new ProductoDAO().Leer();
        }
    }
}
